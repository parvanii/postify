...
export default function Hero() {
  ...
  active:border-b-[2px] active:brightness-90 active:translate-y-[2px]"
            ...
            {/* More Info */}
            <Link href="/about" target="" rel="noreferrer">
              <button
                className="cursor-pointer transition-all 
  bg-[#E823B6] text-white px-6 py-2 rounded-full
  border-[#11020d]
  border-b-[4px] hover:brightness-110 hover:-translate-y-[1px] hover:border-b-[6px]
  active:border-b-[2px] active:brightness-90 active:translate-y-[2px]"
              >
        ...
        <div className="absolute top-32 left-0 transform -translate-x-1/4">
          <img src="/facebook.png" alt="facebook card" className="w-70 drop-shadow-lg rounded-xl" />
        </div>

        <div className="absolute bottom-20 left-16">
          <img src="/x.png" alt="x card" className="w-70 drop-shadow-lg rounded-xl" />
        </div>

        <div className="absolute top-40 right-0 transform translate-x-1/4">
          <img src="/reddit.png" alt="reddit card" className="w-70 drop-shadow-lg rounded-xl" />
        </div>

        <div className="absolute bottom-10 right-20">
          <img src="/instagram.png" alt="instagram card" className="w-70 drop-shadow-lg rounded-xl" />
        </div>
